...
const Footer = () => {
    ...
    const TiktokIcon = () => (<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M12.5 8.5C12.5 8.5 12.5 10 11 10C11 13 8 13.5 6 12C4 10.5 4.5 7.5 7 6C7.5 5.5 7.5 4.5 7 4C6.5 3.5 5.5 3.5 5 4C3 6 2.5 9 4 11C5.5 13 8.5 13.5 10.5 12C11.5 11 12 9.5 12 8.5" stroke="#90A1B9" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /> <path d="M10 12.5C10 12.5 10 14 8.5 14C8.5 17 5.5 17.5 3.5 16C1.5 14.5 2 11.5 4.5 10C5 9.5 5 8.5 4.5 8C4 7.5 3 7.5 2.5 8C0.5 10 0 13 1.5 15C3 17 6 17.5 8 16C9 15 9.5 13.5 9.5 12.5" stroke="#90A1B9" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /> <path d="M13.5 2.5C14.5 2 16 2 17 2.5C18 3 18.5 4 18 5C17.5 6 16.5 6 15.5 5.5C14.5 5 14 4 14.5 3C14.7 2.8 14.8 2.7 15 2.5" stroke="#90A1B9" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /> </svg>)
