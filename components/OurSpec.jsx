...
const OurSpecs = () => {
    ...
    return (
        <div className='px-6 my-20 max-w-6xl mx-auto'>
            <Title visibleButton={false} title='Our Services' description="We offer top-tier service and convenience to ensure your shopping experience in Kenya is smooth, secure and completely hassle-free." />
